  ...
  <div class="content-wrapper">
    <div class="card">
          <div class="card-header">
            <h3 class="card-title">Type Listing</h3>
          </div>
          <!-- /.card-header -->
          <div class="card-body">
            ...
            <tbody>
              @foreach ($types as $type)
                <tr>
                  ...
                  <td align="right">
                    <div class="btn-group">
                      <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#modal-update" onclick="getData('{{$type}}');">Update</button>
                      <a href="{{url('type/delete/'. $type->id)}}" type="button" class="btn btn-danger">Delete</a>
                    </div>
                  </td>
                </tr>
              @endforeach
          ...
          <table width="100%">
            <tr >
              <td style="padding-top:10px;"> {{ $types->links() }} </td>
            </tr>
          </table>
