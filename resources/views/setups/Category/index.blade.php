...
@section('content')
  <div class="content-wrapper">
    <div class="card">
            ...
            <tbody>
              @foreach ($categorys as $category)
                <tr>
                  ...
                  <td align="right">
                    <div class="btn-group">
                      <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#modal-update" onclick="getData('{{$category}}');">Update</button>
          ...
          <table width="100%">
            <tr >
              <td style="padding-top:10px;"> {{ $categorys->links() }} </td>
            </tr>
          </table>
