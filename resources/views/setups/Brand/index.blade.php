...
@section('content')
  <div class="content-wrapper">
    <div class="card">
            ...
            <tbody>
              @foreach ($brands as $brand)
                <tr>
                  ...
                  <td align="right">
                    <div class="btn-group">
                      <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#modal-update" onclick="getData('{{$brand}}');">Update</button>
          ...
          <table width="100%">
            <tr >
              <td style="padding-top:10px;"> {{ $brands->links() }} </td>
            </tr>
          </table>
